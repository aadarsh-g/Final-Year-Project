            ...
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative z-10 flex items-center justify-center p-8">
                ...
                >
                  ...
                  <text x="320" y="358" fill="#1F2937" fontSize="20" fontWeight="600" textAnchor="middle">Sign Up</text>
                  
                  {/* Checkmark Icon */}
                  <g transform="translate(380, 395)">
                    <circle cx="0" cy="0" r="25" fill="#10B981" stroke="#1F2937" strokeWidth="2" />
                    <path d="M-10 0 L-3 7 L10 -8" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                  </g>
